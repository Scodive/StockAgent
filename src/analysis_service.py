...
if __name__ == '__main__':
    ...
    test_exp_name = "your_actual_exp_name"  # Replace with a real exp_name from your Config table
    test_ticker = "YOUR_TICKER.SS"          # Replace with a ticker you ran historical analysis for (e.g., 600036.SS)
    test_start_date = "2023-01-01"          # Adjust date range to match data generated by generate_historical_analysis.py
